...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component {
    ...
    if (self.isAutoSelect) {
        if (self.resultBlock) {
            ...
            self.title = [NSString stringWithFormat:@"%@", self.selectProvinceModel.name, self.selectCityModel.name, self.selectAreaModel.name];
...
- (void)addPickerToView:(UIView *)view {
    ...
    self.doneBlock = ^{
        ...
        if (weakSelf.resultBlock) {
            ...
            weakSelf.title = [NSString stringWithFormat:@"%@", weakSelf.selectProvinceModel.name];
