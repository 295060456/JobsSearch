...
/** 请求成功的Block */
typedef void (^ZBRequestSuccessBlock)(id _Nullable responseObject,
...
/** 请求完成的Block 无论成功和失败**/
typedef void (^ZBRequestFinishedBlock)(id _Nullable responseObject,
...
typedef void (^ZBBatchRequestFinishedBlock)(NSArray * _Nullable responseObjects,
                                            NSArray<NSError *> * _Nullable errors,
                                            NSArray<ZBURLRequest *> *_Nullable requests);
//==================================================================
/** 请求 处理逻辑的方法 Block */
typedef void (^ZBRequestProcessBlock)(ZBURLRequest * _Nullable request,
                                      id _Nullable __autoreleasing * _Nullable setObject);
/** 响应 处理逻辑的方法 Block */
typedef id _Nullable (^ZBResponseProcessBlock)(ZBURLRequest * _Nullable request,
                                               id _Nullable responseObject,
                                               NSError * _Nullable __autoreleasing * _Nullable error);
/** 错误 处理逻辑的方法 Block */
typedef void (^ZBErrorProcessBlock)(ZBURLRequest * _Nullable request,
                                    NSError * _Nullable error);
//==================================================================
/** Request协议*/
...
@required
/** 请求成功的 代理方法*/
- (void)request:(ZBURLRequest *_Nullable)request
successForResponseObject:(id _Nullable)responseObject;

@optional
/** 请求失败的 代理方法*/
- (void)request:(ZBURLRequest *_Nullable)request
failedForError:(NSError *_Nullable)error;

/** 请求进度的 代理方法*/
- (void)request:(ZBURLRequest *_Nullable)request
forProgress:(NSProgress * _Nullable)progress;

/** 请求完成的 代理方法 无论成功和失败**/
- (void)request:(ZBURLRequest *_Nullable)request
finishedForResponseObject:(id _Nullable)responseObject
forError:(NSError *_Nullable)error;

/** 批量请求 全部完成的 代理方法，无论成功和失败*/
- (void)requests:(NSArray<ZBURLRequest *> *_Nullable)requests
batchFinishedForResponseObjects:(NSArray * _Nullable)
responseObjects errors:(NSArray<NSError *> * _Nullable)errors;
